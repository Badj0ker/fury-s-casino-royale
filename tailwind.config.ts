  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        health: { DEFAULT: "hsl(var(--health))", foreground: "hsl(var(--health-foreground))" },
      ...
      keyframes: {
        ...
        "pulse-glow": { "0%, 100%": { boxShadow: "0 0 10px hsl(0 100% 60% / 0.2)" }, "50%": { boxShadow: "0 0 25px hsl(0 100% 60% / 0.5)" } },
