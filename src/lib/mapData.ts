...
export const DUNGEONS: Dungeon[] = [
  ...
  // MAP 4 DUNGEONS (Diana's Shadow Syndicate)
  makeDungeon("jessica-catacombs", "Jessica's Phantom Catacombs", "💀", "jessica-phantom", "shadow-syndicate", 41, [400, 900], 20,
    [["Crypt Phantom", "👻", "dps"], ["Shadow Sentinel", "🛡️", "tank"], ["Void Walker", "🌑", "dps"], ["Dark Siphon", "💊", "healer"]],
    "Jessica the Phantom", "👁️‍🗨️", ["Phase Strike", "Soul Harvest"]),
  makeDungeon("ivy-mainframe", "Ivy's Neon Mainframe", "🖥️", "ivy-neon", "shadow-syndicate", 43, [500, 1100], 22,
    [["Glitch Drone", "🤖", "dps"], ["Firewall Golem", "🧱", "tank"], ["Data Leech", "🦠", "healer"], ["Virus Prime", "👾", "elite"]],
    "Ivy the System Queen", "🖥️", ["System Crash", "Overwrite", "Reboot"]),
  makeDungeon("triss-depths", "Triss's Crimson Depths", "🩸", "triss-crimson", "shadow-syndicate", 45, [600, 1300], 24,
    [["Blood Golem", "🗿", "tank"], ["Crimson Blade", "🗡️", "dps"], ["Scarlet Witch", "🧙", "healer"], ["Red Colossus", "⚔️", "elite"]],
    "Triss the Crimson Lord", "🩸", ["Blood Storm", "Crimson Barrier"]),
  makeDungeon("noa-sanctum", "Noa's Eclipse Sanctum", "🌘", "noa-eclipse", "shadow-syndicate", 48, [700, 1500], 26,
    [["Eclipse Shade", "🌑", "dps"], ["Gravity Titan", "🗿", "tank"], ["Dark Oracle", "🔮", "healer"], ["Void Reaver", "⚫", "elite"]],
    "Noa the Eclipse Arbiter", "🌘", ["Singularity", "Event Horizon", "Dark Matter"]),
  makeDungeon("dakota-core", "Dakota's Shadow Core", "🖤", "diana-throne", "shadow-syndicate", 50, [900, 2000], 30,
    [["Core Guardian", "🛡️", "tank"], ["Shadow Assassin", "🥷", "dps"], ["Void Mender", "💜", "healer"], ["Syndicate General", "⚔️", "elite"]],
    "Dakota the Shadow Sovereign", "🖤", ["Absolute Darkness", "Syndicate's End", "Shadow Apocalypse", "Void Collapse"]),

  // MAP 5 DUNGEONS (Emily's Inferno Colosseum)
  makeDungeon("ari-tunnels", "Ari's Magma Tunnels", "🌋", "ari-molten", "inferno-colosseum", 51, [800, 1800], 22,
    [["Magma Worm", "🐛", "dps"], ["Lava Shield", "🛡️", "tank"], ["Ember Sprite", "✨", "healer"], ["Volcanic Brute", "🗿", "elite"]],
    "Ari the Magma Titan", "🌋", ["Lava Surge", "Eruption"]),
  makeDungeon("lily-vault", "Lily's Obsidian Vault", "♠️", "lily-obsidian", "inferno-colosseum", 53, [900, 2000], 24,
    [["Glass Shard Golem", "💎", "tank"], ["Obsidian Striker", "⚫", "dps"], ["Ash Enchanter", "🧹", "healer"], ["Dark Glass Titan", "🖤", "elite"]],
    "Lily the Obsidian Empress", "♠️", ["Glass Storm", "Mirror Break", "Obsidian Prison"]),
  makeDungeon("camilla-hoard", "Camilla's Dragon Hoard", "🐉", "camilla-dragon", "inferno-colosseum", 56, [1100, 2500], 28,
    [["Hatchling", "🐣", "dps"], ["Drake Sentinel", "🐲", "tank"], ["Wyrm Sage", "🧙", "healer"], ["Ancient Wyrm", "🐍", "elite"]],
    "Camilla the Dragon Lord", "🐉", ["Dragon Fire", "Ancient Roar", "Treasure Guard"]),
  makeDungeon("max-gauntlet", "Max's Hellfire Gauntlet", "⚔️", "max-hellfire", "inferno-colosseum", 59, [1300, 3000], 30,
    [["Hellfire Knight", "⚔️", "tank"], ["Inferno Assassin", "🔥", "dps"], ["Flame Priest", "🔮", "healer"], ["Demon General", "😈", "elite"]],
    "Max the Hellfire King", "👑", ["Apocalypse Flame", "Hellfire Chains", "Demon's Wrath"]),
  makeDungeon("emily-sanctum", "Emily's Eternal Sanctum", "👑🔥", "emily-throne", "inferno-colosseum", 60, [2000, 5000], 35,
    [["Eternal Flame Guard", "🔥", "tank"], ["God's Blade", "⚡", "dps"], ["Divine Healer", "✨", "healer"], ["Celestial Judge", "⚖️", "elite"]],
    "Emily Reborn", "👑🔥", ["World Fire", "Divine Judgment", "Eternal Rebirth", "Final Cataclysm"]),
];
